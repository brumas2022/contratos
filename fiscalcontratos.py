...
def carregar_dados():
    df_contratos = conn.read(worksheet="DADOS_CONTRATOS")
...
if btn_salvar:
    ...
    dados_pdf = {
        ...
        'data_inicio': str(dados_ctr['data_inicio']),
        'data_fim': str(dados_ctr['data_fim']),
        'prazo': str(dados_ctr['prazo']),
        'valor': str(dados_ctr['valor']),
        'licitacao': str(dados_ctr['licitacao']),
        'recurso': str(dados_ctr['recurso']),
        'fiscal_nome': str(dados_ctr['fiscal_nome']),
        'portaria_nro': str(dados_ctr['portaria_nro']),
        'portaria_data': str(dados_ctr['portaria_data']),
        'ocorrencias': ocorrencias,
        'diligencias': diligencias,
        'avaliacao': avaliacao,
        'obs': obs,
